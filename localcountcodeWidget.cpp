...
LocalCountCodeWidget::LocalCountCodeWidget(QWidget *parent) : CountCodeWidget(parent)
{
    initUi();
}

LocalCountCodeWidget::~LocalCountCodeWidget()
{
}

void LocalCountCodeWidget::initForm()
{
...
void LocalCountCodeWidget::initBottomWidget()
{
    ...
    connect(openFileBtn, &QPushButton::clicked, this, &LocalCountCodeWidget::onOpenFile);
    connect(openDirBtn, &QPushButton::clicked, this, &LocalCountCodeWidget::onOpenPath);
    connect(clearBtn, &QPushButton::clicked, this, &LocalCountCodeWidget::onClearData);
}

void LocalCountCodeWidget::deleteAllData()
{
...
void LocalCountCodeWidget::setLabelStyle()
{
...
bool LocalCountCodeWidget::checkFile(const QString &fileName)
{
...
void LocalCountCodeWidget::countCode(const QString &filePath)
{
    QDir dir(filePath);
...
void LocalCountCodeWidget::countCode(const QStringList &files)
{
    int lineCode;
    int lineBlank;
    int lineNotes;
...
void LocalCountCodeWidget::countCode(const QString &fileName, int &lineCode, int &lineBlank, int &lineNotes)
{
...
void LocalCountCodeWidget::onOpenFile()
{
    ...
    if (files.size() > 0) {
        ...
        QtConcurrent::run(this, QOverload<const QStringList &>::of(&LocalCountCodeWidget::countCode), files);
    }
}

void LocalCountCodeWidget::onOpenPath()
{
    ...
    if (!path.isEmpty()) {
        ...
        listFile.clear();
        countCode(path);
        QtConcurrent::run(this, QOverload<const QStringList &>::of(&LocalCountCodeWidget::countCode), listFile);
    }
}

void LocalCountCodeWidget::onClearData()
{   
